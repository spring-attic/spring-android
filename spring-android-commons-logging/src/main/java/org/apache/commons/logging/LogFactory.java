...
import org.apache.commons.logging.impl.AndroidLogFactory;

/**
 * <p>
 * Factory for creating {@link Log} instances, which always delegates to an
 * instance of {@link AndroidLogFactory}.
 * 
 * </p>
 * 
 * @author Roy Clarkson
...
public abstract class LogFactory {
  ...
  static LogFactory logFactory = new AndroidLogFactory();
   ...
   * This property is not used but preserved here for compatibility.
   */
  public static final String FACTORY_DEFAULT = "org.apache.commons.logging.impl.AndroidLogFactory";
   ...
   * <code>org.apache.commons.logging.impl.AndroidLogFactory</code>).</li>
   * </ul>
   * 
   * <p>
  ...
  public static void release(ClassLoader classLoader) {
    // since Android logging does not make use of classloaders, there is nothing
    // to do here
  }
  ...
  // by AndroidLogFactory

  /**
   * This method exists to ensure signature compatibility.
   */
  protected static Object createFactory(String factoryClass, ClassLoader classLoader) {
    throw new UnsupportedOperationException("Operation [factoryClass] is not supported in Android logging.");
  }
  ...
  protected static ClassLoader directGetContextClassLoader() {
    throw new UnsupportedOperationException("Operation [directGetContextClassLoader] is not supported in Android logging.");
  }
  ...
  protected static ClassLoader getContextClassLoader()
    ...
    throw new UnsupportedOperationException("Operation [getContextClassLoader] is not supported in Android logging.");
  }
  ...
  protected static ClassLoader getClassLoader(Class clazz) {
    throw new UnsupportedOperationException("Operation [getClassLoader] is not supported in Android logging.");
  }
  ...
  protected static boolean isDiagnosticsEnabled() {
    throw new UnsupportedOperationException("Operation [isDiagnosticsEnabled] is not supported in Android logging.");
  }
  ...
  protected static void logRawDiagnostic(String msg) {
    throw new UnsupportedOperationException("Operation [logRawDiagnostic] is not supported in Android logging.");
  }
  ...
  protected static LogFactory newFactory(final String factoryClass,
    ...
    throw new UnsupportedOperationException("Operation [newFactory] is not supported in Android logging.");
  }
