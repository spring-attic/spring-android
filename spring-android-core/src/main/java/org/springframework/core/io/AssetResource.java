...
public class AssetResource extends AbstractResource {
     ...
     * <p>The Android AssetManager will be used for
    ...
    /**
     * This implementation checks the length of the underlying AssetFileDescriptor, 
     * if available.
    ...
    public boolean equals(Object obj) {
        return (obj == this ||
            (obj instanceof AssetResource && this.fileName.equals(((AssetResource) obj).fileName)));
    }
